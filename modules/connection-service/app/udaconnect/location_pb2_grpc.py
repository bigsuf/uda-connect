...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Filter = channel.unary_unary(
                ...
                request_serializer=location__pb2.LocationQuery.SerializeToString,
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Filter': grpc.unary_unary_rpc_method_handler(
                    servicer.Filter,
                    request_deserializer=location__pb2.LocationQuery.FromString,
...
class LocationService(object):
    ...
    def Filter(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LocationService/Filter',
            location__pb2.LocationQuery.SerializeToString,
