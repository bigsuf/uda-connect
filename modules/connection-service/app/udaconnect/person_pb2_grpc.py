...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Filter = channel.unary_unary(
                ...
                request_serializer=person__pb2.PersonQuery.SerializeToString,
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Filter': grpc.unary_unary_rpc_method_handler(
                    servicer.Filter,
                    request_deserializer=person__pb2.PersonQuery.FromString,
...
class PersonService(object):
    ...
    def Filter(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/PersonService/Filter',
            person__pb2.PersonQuery.SerializeToString,
