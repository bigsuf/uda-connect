...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0cperson.proto\"Q\n\x06Person\x12\n\n\x02id\x18\x01 \x01(\x05\x12\x12\n\nfirst_name\x18\x02 \x01(\t\x12\x11\n\tlast_name\x18\x03 \x01(\t\x12\x14\n\x0c\x63ompany_name\x18\x04 \x01(\t\"&\n\nPersonList\x12\x18\n\x07persons\x18\x01 \x03(\x0b\x32\x07.Person\"\x19\n\x0bPersonQuery\x12\n\n\x02id\x18\x01 \x01(\x05\x32\x34\n\rPersonService\x12#\n\x06\x46ilter\x12\x0c.PersonQuery\x1a\x0b.PersonListb\x06proto3'
)
...
_PERSONQUERY = _descriptor.Descriptor(
  name='PersonQuery',
  full_name='PersonQuery',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='PersonQuery.id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['PersonQuery'] = _PERSONQUERY
...
PersonQuery = _reflection.GeneratedProtocolMessageType('PersonQuery', (_message.Message,), {
  'DESCRIPTOR' : _PERSONQUERY,
  '__module__' : 'person_pb2'
  # @@protoc_insertion_point(class_scope:PersonQuery)
  })
_sym_db.RegisterMessage(PersonQuery)
...
_PERSONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Filter',
    full_name='PersonService.Filter',
    index=0,
    containing_service=None,
    input_type=_PERSONQUERY,
